...
function NavBar() {
  const homepageUrl = "https://madhurimatummala.github.io/portfolio" || "/";
  ...
  return (
    ...
    >
      <Container>
        <Navbar.Brand href={homepageUrl} className="d-flex">
        ...
        <Navbar.Collapse id="responsive-navbar-nav">
          <Nav className="ms-auto" defaultActiveKey="#home">
            ...
            <Nav.Item>
              ...
              >
                <CgToolbox style={{ marginBottom: "2px" }} /> Switch Theme
              </Nav.Link>
            </Nav.Item>
